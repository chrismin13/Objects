...
- First-class Spaces with an All/Personal/Work sidebar pill, Space-scoped lists, and device-local selection
- Areas, projects, project headings, checklists, notes, tags, inherited tags, deadlines, and start dates
- Project scheduling across Today, Upcoming, Anytime, and Someday, including deadlines, completion, duplication, and recoverable Trash
- Things-style Move destinations for Inbox, areas, and projects
- Repeating to-dos with editable frequency, interval, and next date
- Browser reminders and calendar-event display in Today and Upcoming
...
- Deadlines, Repeating, and All Projects views
- Checklists, task duplication through projects, project completion, completion undo, headings, search, and restoration
...
- URL capture for shared text, links, task selection, and initial views
