...
#repeating-button.active { color: var(--blue); background: var(--surface-hover); }
...
.repeating-group .section-header { align-items: flex-start; }
.repeating-group .section-header h2 { margin: 0; }
.repeating-group .section-header p { margin: 2px 0 0; color: var(--muted); font-size: 11px; font-weight: 450; }
.repeating-kind-label { display: block; margin: 12px 2px 4px; color: var(--muted); font-size: 10px; font-weight: 680; letter-spacing: .06em; text-transform: uppercase; }
.repeating-empty { margin: 9px 2px 0; color: var(--muted); font-size: 12px; }
.repeat-occurrence { color: var(--blue); }
.occurrence-notice { display: grid; grid-template-columns: 18px minmax(0, 1fr); gap: 9px; margin: 2px 0 14px; padding: 11px 12px; border: 1px solid color-mix(in srgb, var(--blue) 24%, var(--border)); border-radius: 9px; background: color-mix(in srgb, var(--blue-soft) 70%, transparent); }
.occurrence-notice > svg { width: 17px; height: 17px; color: var(--blue); }
.occurrence-notice strong { font-size: 12px; }
.occurrence-notice p { margin: 3px 0 5px; color: var(--muted); font-size: 12px; line-height: 1.4; }
.repeat-summary { display: grid; gap: 2px; margin-bottom: 4px; }
.repeat-summary strong { font-size: 12px; }
.repeat-summary span { color: var(--muted); font-size: 11px; }
...
.check-visual { width: 15px; height: 15px; border-width: 1.35px; border-radius: 50%; }
...
.quick-add-dot { width: 16px; height: 16px; border-radius: 50%; }
.section-add {
  min-height: 33px;
  padding: 5px 3px;
  border-bottom: 0;
...
@media (max-width: 820px) {
  ...
  .sidebar { width: min(300px, 82vw); background: var(--sidebar); backdrop-filter: none; }
  .window-bar { height: 52px; padding: 6px 7px; gap: 3px; }
  .sidebar-close:focus-visible { outline-offset: -4px; }
  ...
  .mobile-header .icon-button:focus-visible { outline-offset: -4px; }
  .content {
  ...
  .view-title-row { align-items: flex-start; gap: 8px; }
  .view-icon { width: 26px; height: 26px; margin-top: 4px; }
  .view-title-row h1 { min-width: 0; font-size: 33px; overflow-wrap: anywhere; }
  .header-actions { align-self: flex-start; margin-top: -4px; }
  .view-subtitle,
  ...
  .task-select svg { width: 14px; height: 14px; }
  .task-row:focus-within .task-select,
  .task-select.active { opacity: 1; }
  .task-select.active { border-color: var(--blue); }
  ...
  .empty-state + .section .section-add { display: flex; color: var(--muted); opacity: .9; }
  .quick-add-row { min-height: 44px; padding: 6px 1px; border-bottom: 0; }
  .empty-state { display: block; padding: 54px 14px 30px; }
  ...
  .inspector-actions { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 7px; margin-top: 12px; padding-top: 2px; }
  .inspector-actions .button,
  .inspector-actions .danger-button { min-height: 40px; padding: 7px 9px; font-size: 12px; }
}
