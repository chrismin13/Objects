...
export type WorkspaceToDoSortEvent = { movedIds: string[]; orderedIds: string[]; sectionKey: string };

export function mountWorkspaceToDoSortable(root: ParentNode, selectedIds: string[], onEnd: (event: WorkspaceToDoSortEvent) => void): void {
